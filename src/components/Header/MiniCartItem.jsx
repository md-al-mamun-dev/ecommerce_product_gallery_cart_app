...
export default function MiniCartItem({data}) {
  ...
  return (
    <div className="flex items-center justify-between">
        ...
        <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">{ totalItemPrice}</span>
        <button onClick={()=>dispatch(removeFromCart(data.id))} className=' ml-2 courser-pointer hover:text-red-500 group'>
          <svg 
                width="16" 
                height="16" 
                viewBox="0 0 24 24" 
